...
fac    = 0; invfac  = 0; expx  = 0; sinx      = 1; 
invnsq = 0; invmnsq = 0; invnk = 0; fibonacci = 0;
...
# Sine series sin(x) = x - x^3/3! + x^5/5! - x^7/7! + ... 
    ...
    x = math.radians(x); # Convert to radian 
    term = x
    ...
    print 'sin(',math.degrees(x),') =', sumf, ' and convergence took', n/2-1, 'steps\n'   
