...
\label{intro}
%Font series: \textbf (bold), \textmd (medium width, default)
%Font shape: textup (default), \textit (italics), \textsl (slanted), \textsc %(small caps)
%Fontsize \tiny, \scriptsize, \footnotesize, \small, \large, \Large, \LARGE
...
% \mathrm (Serif), \mathsf (Sans Serif), \mathtt (Typewriter), \mathcal 
% (Caligraphic), \Bbbk or \mathbb (AMS), \mathfrak (Fraktur) 
