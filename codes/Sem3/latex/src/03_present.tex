...
\title[\tiny Expert Committee Interview]{Problems in the Statics \& 
Kinetics of Nematic Liquid Crystals}
...
\begin{figure}
\centering
\includegraphics[width=1.4in, height=1.0in, angle=0]{lc.pdf} 
\hspace{0.3 in}
\includegraphics[width=1.4in, height=1.0in, angle=0]{biaxial.pdf} \\
\end{figure}
}

\frame{\frametitle{Statics : Free energy, phase diagram}
\begin{eqnarray*}
F &=& \int d^3{\bf x} [\frac{1}{2}ATr{\bf Q}^{2} + \frac{1}{3}BTr{\bf Q}^{3} + 
...
\begin{figure}
\includegraphics[width=2.1in, height=1.6in, angle=0]{frener.pdf}
\includegraphics[width=2.1in, height=1.8in]{phasediagram.pdf}
\end{figure}
}
...
\begin{figure}
\includegraphics[width=3.5in, height=2.5in, angle=0]{flowchart.pdf}
\end{figure}
}
...
\subfigure[$\; \kappa = 0 $]{
    \centering
    \includegraphics[width=1.8in, height=1.4in, angle=0]{fig2_interface.pdf}
}
\subfigure[$\; \kappa = 18 $]{
    \centering
    \includegraphics[width=1.8in, height=1.4in, angle=0]{AKSTnew18.pdf}
}
\end{figure}
\end{itemize} 
}
...
\subfigure[$\; \kappa = 36 $]{
     \centering
     \includegraphics[width=1.8in, height=1.4in, angle=0]{anc1.pdf}
}
\hspace{0.35 cm}
\subfigure[$\; \kappa = 36 $]{
     \centering
     \includegraphics[width=1.8in, height=1.4in, angle=0]{anc3.pdf}
}
\end{figure}
}
...
\subfigure[$L_2 = 0 $]{
     \centering
     \includegraphics[width=0.8in, height=0.8in, angle=0]{circular.pdf}
}
\hspace{0.35 cm}
\subfigure[$L_2 = 10L_1$]{
     \centering
     \includegraphics[width=0.8in, height=0.8in, angle=0]{ellip1.pdf}
}
\hspace{0.35 cm}
\subfigure[$L_2 = -L_1$]{
     \centering
     \includegraphics[width=0.8in, height=0.8in, angle=0]{homo.pdf}
}
\end{figure}
\end{itemize} 
}
...
\subfigure[]{
     \centering
     \includegraphics[width=0.6in, height=0.6in, angle=0]{Suniax.pdf}
}
\hspace{0.35 cm}
\subfigure[]{
     \centering
     \includegraphics[width=0.62in, height=0.62in, angle=0]{2dS_00000100.pdf}
}
\hspace{0.35 cm}
\subfigure[]{
     \centering
     \includegraphics[width=0.62in, height=0.62in, angle=0]{2dSch_00000100.pdf}
}
\end{figure}
\end{itemize} 
}
...
\subfigure[]{
     \centering
     \includegraphics[width=1.3in, height=1.1in, angle=0]{fig5c_defprof.pdf}
}
\subfigure[$C_x$]{
     \centering
     \includegraphics[width=1.3in, height=1.1in, angle=0]{ST1.pdf}
}
\subfigure[$C_y$]{
     \centering
     \includegraphics[width=1.3in, height=1.1in, angle=0]{ST2.pdf}
}
\end{figure}
\begin{itemize}
...
\subfigure[]{
     \centering
     \includegraphics[width=1.0in, height=1.0in, angle=0]{3dSN_biax_45.pdf}
}
\subfigure[]{
     \centering
     \includegraphics[width=1.0in, height=1.0in, angle=0]{3dSN_biax_49.pdf}
}
\subfigure[]{
     \centering
     \includegraphics[width=1.0in, height=1.0in, angle=0]{3dSN_biax_51.pdf}
}
\end{figure}
\end{itemize}
}
